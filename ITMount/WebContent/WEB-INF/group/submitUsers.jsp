	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><t:i18n id='group.panel.confirm.user'/></h4>
			</div>
			<div class="modal-body">
				...
				<div class="form-group" id='passed'>
					<label for="login-username"><i class="icon-user"></i> <b>
							<t:i18n id='group.panel.message.pas'/></b></label> <textarea name="messagePassed" class="form-control"
						id="group-name-edit"  placeholder=""></textarea>
				</div>
				
				<div class="form-group" id='failed'>
					<label for="login-username"><i class="icon-user"></i> <b>
							<t:i18n id='group.panel.message.fail'/></b></label> <textarea name="messageFailed" class="form-control"
						id="group-name-edit" placeholder=""></textarea>
				</div>
				...
				<div class="form-group">
					<button type="submit" class="btn btn-primary pull-right" name="action"
						value="leave"><t:i18n id='group.panel.submit'/></button>
