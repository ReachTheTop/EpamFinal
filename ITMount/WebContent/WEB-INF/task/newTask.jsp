...
<body>
	...
	<div class="bs-example">
		...
		<a href="#myModal" class="btn btn-lg btn-primary"  style="margin-left:13px;" data-toggle="modal">Create Task</a>
					...
					<div class="modal-body">
						<form action="TaskServlet?action=createTask&id_group=${id_group }" method="post" enctype="multipart/form-data"
							...
							<div class="form-group">
								<label for="login-username"><i class="icon-user"></i> <b>Task
										Description</b></label>
										 <p><textarea class ="form-control" name ="task_description" rows="3" name="text"></textarea></p>
							</div>
							
							<div class="form-group">
								<label for="login-username"><i class="icon-user"></i> <b>Deadline</b></label> <input name="task_deadline" class="form-control"
					...
					<div class="basic-login">
						<form action="TaskServlet?action=createTask&id_group=${id_group }" method="post" enctype="multipart/form-data"
							...
							<div class="form-group">
								<label for="login-username"><i class="icon-user"></i> <b>Task
										Description</b></label>
										 <p><textarea name ="task_description" rows="3" cols="55" name="text"></textarea></p>
							</div>
