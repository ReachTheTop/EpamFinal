                    ...
                    <div class="ibox-content mailbox-content">
                        <div class="file-manager">
                            ...
                            <ul class="folder-list m-b-md" style="padding: 0">
                                <li><a href="<c:url value='FeedbackServlet?action=inbox' />"> <i class="fa fa-inbox "></i> <t:i18n id="Feedback.menu.Inbox"/> <span class="label label-warning pull-right">${newMessage}</span> </a></li>
